...
var ctx = document.getElementById("singelBarChart");
  ...
  try {
    // Recent Report
    const jc = 'rgba(0,181,233,0.8)'
    const poly = 'rgba(0,173,95,0.8)'

    var elements = 4
    var data1 = [67, 70, 80, 88]
    var data2 = [69, 75, 79, 87]

    var ctx = document.getElementById("recent-rep-chart-G");
    if (ctx) {
      ctx.height = 250;
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
          ...
          datasets: [
            {
              label: 'A level/IB degree holders',
              backgroundColor: jc,
    ...
    var ctx = document.getElementById("percent-chart-G");
    if (ctx) {
      ctx.height = 280;
      var myChart = new Chart(ctx, {
        type: 'doughnut',
